...
int main(){
    ...
    printf("cpt2 : %d/%d (%f s/%d s)= ",cpt2,nb_iterations,(double)cpt2/(double)nb_iterations*(double)duree_audio,duree_audio);
        ...
        printf("%d Hz ",freq_maximale*freq_echantillonnage/tau2);
        note_jouee = note(freq_maximale*freq_echantillonnage/tau2);
        printf("-- n° touche du piano : %d\n",note_jouee);
    }
